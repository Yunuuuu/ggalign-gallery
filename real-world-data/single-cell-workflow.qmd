...
Data was processed from
https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE210347. The preprocessing
workflow is documented in detail here:
<https://github.com/Yunuuuu/ggalign-research/blob/main/Figure%206-data-preprocess.qmd>.


## Load processed data
```{r}
umap_subset <- readRDS("rawdata/single-cell-workflow/umap_subset.rds")
summarized <- readRDS("rawdata/single-cell-workflow/summarized.rds")
umap <- readRDS("rawdata/single-cell-workflow/umap.rds")
clidata <- readRDS("rawdata/single-cell-workflow/clidata.rds")
```
