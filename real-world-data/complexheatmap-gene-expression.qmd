---
categories: [quad_layout(), ggheatmap()]
---

# Heatmap of gene expression matrix

We utilize the gene expression dataset included in the R `ComplexHeatmap`
package to reproduce the multi-panel gene expression heatmap from
...
We load the example dataset and process it for visualization, the data
preparation code is collapsed in the source but can be expanded for inspection.
```{r}
#| code-fold: true
